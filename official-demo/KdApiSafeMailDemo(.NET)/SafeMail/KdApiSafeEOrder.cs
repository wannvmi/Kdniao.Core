...
namespace KdGoldAPI
{
    /**
    *
    * 快递鸟隐私电子面单接口，返回电子面单模板中根据要求隐藏指定收寄方电话号码
    * 申请帐号，在正式环境中下单才可以使用。
    * 测试环境无法使用隐私电子面单。
    *
	* @技术QQ群: 340378554
    ...
    */
    public class KdApiSafeEOrder
    {
        ...
        //测试环境地址
        //private string ReqURL = "http://testapi.kdniao.com:8081/api/apiservice";

        /// <summary>
        /// Json方式  隐私电子面单
        /// </summary>
        /// <returns></returns>
        public string safeMailEOrder()
        {
            string requestData = "{'OrderCode': 'SF201701052033399759'," +
                                 "'ShipperCode':'SF'," +
                                  "'PayType':1," +
                                  "'ExpType':1," +
                                  "'Cost':1.0," +
                                  ...
                                  "'Remark':'小心轻放'," +
                                  "'IsNotice':'1'," +
                                  "'AddService':[{'Name':'SafeMail','Value':'3'}]," +
